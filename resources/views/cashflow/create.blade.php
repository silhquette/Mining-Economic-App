                    ...
                    <form action="{{ route('cashflow.store', $project->id) }}" method="post">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="flex-1 mb-4">
                                ...
                                <x-text-input min=0 max=100 id="depreciation" class="block mt-1 w-full" type="number" name="depreciation" :value="old('depreciation')" />
                                <x-input-error :messages="$errors->get('depreciation')" class="mt-2" />
                            </div>
                            <div class="flex-1 mb-4">
                                <x-input-label for="net_income" :value="__('Net Income')" />
                                <x-text-input min=0 id="net_income" class="block mt-1 w-full" type="number" name="net_income" :value="old('net_income')" readonly/>
                                <x-input-error :messages="$errors->get('net_income')" class="mt-2" />
                            </div>
                            <div class="flex-1 mb-4">
                                <x-input-label for="tax" :value="__('Tax')" />
                                <x-text-input min=0 id="tax" class="block mt-1 w-full" type="number" name="tax" :value="old('tax')" />
