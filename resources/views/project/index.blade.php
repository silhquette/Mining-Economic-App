    ...
    <div class="p-6 sm:rounded-lg max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            @foreach ($projects as $project)
                <div
                    class="group/project flex flex-col justify-between bg-white text-gray-900 dark:text-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 relative hover:bg-transparent hover:outline hover:outline-gray-800 dark:hover:outline-gray-200">
                    ...
                    <div>
                        ...
                        <a href="{{ route('project.edit', $project->id) }}"
                            class="absolute top-4 right-11 dark:text-gray-200 text-gray-800 text-xl hover:dark:text-gray-300 hover:text-gray-600 invisible group-hover/project:visible"><i
